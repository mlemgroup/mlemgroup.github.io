        ...
        <div className="flex flex-col gap-6" style={{ paddingBottom: "60px" }}>
          ...
          <div className="space-y-4 px-4">
            ...
            <p className="text-lg text-zinc-700 dark:text-zinc-300">
              Mlem is a beautiful, intuitive open source iOS client for Lemmy
              that lets you effortlessly participate in conversations across all
              Lemmy servers.
            </p>
          ...
          <div className="relative w-full overflow-visible h-96">
            ...
            <div
              className="absolute -left-10 bottom-0 w-40 h-72 rounded-t-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 overflow-hidden shadow-md"
            ...
            <div
              className="absolute -right-10 bottom-0 w-40 h-72 rounded-t-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 overflow-hidden shadow-md"
              style={{ marginBottom: "-60px" }}
            >
              <img
            ...
            <div
              className="absolute left-1/2 transform -translate-x-1/2 bottom-0 w-48 h-88 rounded-t-2xl border border-zinc-200 dark:border-zinc-700 z-10 bg-white dark:bg-zinc-800 overflow-hidden shadow-lg"
              style={{ marginBottom: "-60px" }}
            >
              <img
