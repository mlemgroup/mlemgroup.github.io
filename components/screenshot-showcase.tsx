...
const screenshots = [
  ...
  },
  {
    ...
    caption: "Find anything instantly with powerful cross-instance search capabilities.",
  },
  {
    id: 3,
    src: "/screenshots/showcase/colored_comment_indents.jpeg",
    alt: "Mlem colored comment indents",
    caption: "Navigate complex conversations easily with color-coded comment thread indicators.",
  },
  {
    id: 4,
    src: "/screenshots/showcase/configurable.jpeg",
    alt: "Mlem configurable settings",
    caption: "Tailor every aspect of the app to your preferences with extensive customization options.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    caption: "Personalize your home screen with Mlem's beautifully designed app icons.",
  },
]
...
export function ScreenshotShowcase() {
  return (
    <div className="w-full">
      <h2 className="text-2xl md:text-3xl font-bold mb-6">See Mlem in Action</h2>
