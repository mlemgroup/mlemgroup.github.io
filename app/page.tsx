import { MessageSquare, Globe, Zap, Code, GitBranch, Settings, Shield, Heart } from "lucide-react"
      ...
      <main className="flex-1">
        ...
        <section className="hidden md:block py-12 pt-4 pb-0 px-4 bg-gradient-to-br from-sky-500/10 via-sky-500/5 to-transparent relative">
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-row items-center gap-8" style={{ paddingBottom: "60px" }}>
              ...
              <div className="w-1/2 flex justify-center">
                <div className="relative w-full" style={{ height: "420px" }}>
                  ...
                  <div className="absolute left-8 bottom-0 w-44 h-80 rounded-t-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 overflow-hidden" style={{ marginBottom: "-60px" }}>
                    <img 
                  ...
                  <div className="absolute right-8 bottom-0 w-44 h-80 rounded-t-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 overflow-hidden" style={{ marginBottom: "-60px" }}>
                    <img 
                  ...
                  <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 w-52 h-96 rounded-t-2xl border border-zinc-200 dark:border-zinc-700 z-10 bg-white dark:bg-zinc-800 overflow-hidden" style={{ marginBottom: "-60px" }}>
                    <img 
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <FeatureCard
                ...
                title="Open Source"
                description="Built transparently with the community, for the community, with all code available on GitHub."
              />
            </div>
          </div>
        </section>
        ...
        <section className="py-12 pt-8 pb-8 px-4 bg-zinc-100 dark:bg-zinc-800 border-y border-zinc-200 dark:border-zinc-700">
          <div className="container mx-auto max-w-6xl">
            <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 border border-zinc-200 dark:border-zinc-700">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">License</h2>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
                Mlem is fully open source, licensed under the GPL v3.0 with an addendum for Apple App Store compliance. See <a href="https://github.com/mlemgroup/mlem/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-sky-500 hover:underline">the license</a> for details.
              </p>
              <p className="text-zinc-700 dark:text-zinc-300 mb-4">
                We welcome pull requests and love external contributions! Missing a feature? Let us know on our <a href="https://github.com/mlemgroup/mlem/issues" target="_blank" rel="noopener noreferrer" className="text-sky-500 hover:underline">issue tracker</a>.
              </p>
              <p className="text-zinc-700 dark:text-zinc-300">
                Don't want to deal with the App Store or TestFlight? Download the code and install the latest build yourself.
              </p>
              <div className="flex flex-wrap gap-3 mt-4">
                <a 
                  href="https://github.com/mlemgroup/mlem/blob/main/LICENSE" 
                  target="_blank" 
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8">
              <div className="md:w-1/2">
                <div className="bg-white dark:bg-zinc-800 rounded-xl p-5 sm:p-6 border border-zinc-200 dark:border-zinc-700">
                  <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Want to chat about Mlem?</h2>
                  <p className="text-zinc-700 dark:text-zinc-300 mb-4">
                    You can discuss and ask questions about Mlem at the community on lemmy.ml or join us on Matrix.
                  </p>
              ...
              <div className="md:w-1/2">
                <div className="bg-white dark:bg-zinc-800 rounded-xl p-5 sm:p-6 border border-zinc-200 dark:border-zinc-700 h-full">
                  <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">The Mlem Group</h2>
                  <p className="text-zinc-700 dark:text-zinc-300 mb-4">
                    <a href="https://techhub.social/@weston" target="_blank" rel="noopener noreferrer" className="text-sky-600 dark:text-sky-400 hover:underline transition-colors">Weston</a> <span className="text-zinc-400 dark:text-zinc-600 mx-1">&middot;</span> 
                    <a href="https://github.com/EricBAndrews" target="_blank" rel="noopener noreferrer" className="text-sky-600 dark:text-sky-400 hover:underline transition-colors">Eric</a> <span className="text-zinc-400 dark:text-zinc-600 mx-1">&middot;</span> 
                    <a href="https://github.com/JakeShirley" target="_blank" rel="noopener noreferrer" className="text-sky-600 dark:text-sky-400 hover:underline transition-colors">Jake Shirley</a> <span className="text-zinc-400 dark:text-zinc-600 mx-1">&middot;</span> 
                    <a href="https://github.com/ShadowJonathan" target="_blank" rel="noopener noreferrer" className="text-sky-600 dark:text-sky-400 hover:underline transition-colors">ShadowJonathan</a>
                  </p>
                  <p className="text-zinc-700 dark:text-zinc-300 font-medium">Other Contributors</p>
                  <p className="text-zinc-700 dark:text-zinc-300 mt-3">
                    We love community contributions! Visit our GitHub page to see the developers who have helped make this app possible.
                  </p>
                  <div className="mt-4">
                    <a 
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="bg-gradient-to-br from-sky-500/10 via-sky-500/5 to-transparent rounded-xl p-5 sm:p-6 border border-sky-200 dark:border-sky-900/30">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold mb-2">Ready to transform your Lemmy experience?</h2>
                  <p className="text-zinc-700 dark:text-zinc-300">
                    Join the open source community and download Mlem today.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a href="https://apps.apple.com/app/id6450543782" target="_blank" rel="noopener noreferrer" className="h-auto w-40">
                    <img 
                      src="/Download_on_the_App_Store_Badge_US-UK_RGB_blk_092917.svg" 
                      alt="Download on the App Store" 
