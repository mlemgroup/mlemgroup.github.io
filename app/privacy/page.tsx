      ...
      <main className="flex-1">
        <section className="py-12 px-4">
          <div className="container mx-auto max-w-4xl">
            <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center">Privacy Policy for Mlem Mobile Application</h1>
            ...
            <div className="bg-white dark:bg-zinc-800 rounded-xl p-8 border border-zinc-200 dark:border-zinc-700 space-y-6">
              ...
              <h2 className="text-xl font-bold mt-6 mb-3">Servers and Data Control</h2>
              <p className="text-zinc-700 dark:text-zinc-300 text-justify">
